...
func newConfig() *config {
	...
	fs.BoolVar(&cfg.ec.UnsafeAllowClusterVersionDowngrade, "unsafe-allow-cluster-version-downgrade", false, "Enables only one single minor cluster version downgrade at a time automatically.")
